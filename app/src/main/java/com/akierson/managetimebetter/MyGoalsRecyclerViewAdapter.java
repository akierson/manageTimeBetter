...
import com.akierson.managetimebetter.fragment_goals.OnListFragmentInteractionListener;
...
public class MyGoalsRecyclerViewAdapter extends RecyclerView.Adapter<MyGoalsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyGoalsRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
